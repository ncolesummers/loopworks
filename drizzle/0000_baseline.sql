CREATE TYPE "public"."approval_status" AS ENUM('requested', 'approved', 'rejected', 'cancelled', 'expired', 'applied', 'bypassed');--> statement-breakpoint
CREATE TYPE "public"."artifact_type" AS ENUM('plan', 'validation_report', 'test_plan', 'patch', 'pr_intent', 'deployment_summary', 'log_summary', 'trace', 'screenshot', 'other');--> statement-breakpoint
...
CREATE TABLE "agent_plans" (
	...
	"agent_name" text DEFAULT 'planner' NOT NULL,
...
CREATE TABLE "repositories" (
	...
	"health" "repo_health" DEFAULT 'healthy' NOT NULL,
	"framework" text DEFAULT 'Unknown' NOT NULL,
	"default_branch" text DEFAULT 'main' NOT NULL,
	"ci_commands" text[] DEFAULT '{}' NOT NULL,
	"docs_href" text,
	"observability_href" text,
	"design_system_href" text,
	"enabled_loops" text[] DEFAULT '{}' NOT NULL,
	"validation_gates" text[] DEFAULT '{}' NOT NULL,
	"last_synced_at" timestamp with time zone,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE INDEX "approval_transition_events_run_created_at_idx" ON "approval_transition_events" USING btree ("run_id","occurred_at");--> statement-breakpoint
