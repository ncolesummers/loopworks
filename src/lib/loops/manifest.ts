...
export const defaultLoopManifest: LoopManifest = loopManifestSchema.parse({
  ...
  milestones: [
    ...
    {
      key: "M5",
      name: "M5 MVP Close: Security, Design, and Coverage Gates",
      description: "Release confidence, design signoff, and security gate.",
      personaTestIds: ["A03", "R01", "R02", "S01", "S02", "S03", "S04"],
      issues: [
        {
          title: "Validation and PR checkpoint views",
          labels: ["kind:feature", "milestone:M5", "area:pr-flow"],
          template: "feature.yml",
          personaTestIds: ["A03", "R01", "R02"],
        },
        {
          title: "MVP security review",
          labels: ["kind:security", "milestone:M5", "priority:p0"],
