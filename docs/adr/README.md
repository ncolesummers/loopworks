...
| [0024](0024-phased-security-scanning-in-the-validation-chain.md) | Accepted | Run pinned security scanners through repository-owned commands in the existing validation chain, separating where a scanner runs from what its findings do. |
...
| [0033](0033-project-scoped-polly-model-routing.md) | Proposed | Encode subscription-aware model tiers, read-only dual review, and contributor-safe issue publication in a project-scoped Polly bundle. |
